    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 py-3" style="background-image: linear-gradient(to right, blue, green);">
                <div class="row">
                    <div class="col-md-3">
                        <img src="./assets/img/admins/<?= $admins[0]->image ? $admins[0]->image : "default_image_user.png" ?>" alt="Admin Image" class="rounded-circle bg-white" style="width: 200px ; height: 200px;">
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2">
                            <strong>Email: </strong><span><?= $admins[0]->email ? $admins[0]->email : "Not Yet Available" ?></span>
                        </div>
                        <div class="col-md-12 mb-2">
                            <strong>Mobile Number: </strong><span><?= $admins[0]->mobile_number ? $admins[0]->mobile_number : "Not Yet Available" ?></span>
                        </div>
                        <div class="col-md-12 mb-2">
                        ...
                        <div class="col-md-12 mb-2">
                            <strong>Image: </strong><span><?= $admins[0]->image ? $admins[0]->image : "Not Yet Available" ?></span>
                        </div>
                        <div class="col-md-12 mb-2">
