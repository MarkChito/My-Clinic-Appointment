...
<head>
    ...
    <meta name="author" content="Kate Tungol" />
...
<body id="page-top">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0" data-bs-toggle="modal" data-bs-target="#book_now">
                                <span class="d-flex align-items-center">
    ...
    <aside class="text-justify bg-gradient-primary-to-secondary" id="about_us">
        <div class="container px-5">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Munchkin is a highly skilled and compassionate pediatrician with over 10 years of experience. She completed her medical degree at Harvard University and completed her pediatric residency at ABC Hospital. Dr. Munchkin is board-certified in pediatrics and is an active member of the Norway Academy of Pediatrics.</p>
                            ...
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Sugarplum is a dedicated and experienced obstetrician-gynecologist (OB-GYN) with a passion for providing comprehensive care to women throughout all stages of their lives. She received her medical degree from Harvard University and completed her residency training in Obstetrics and Gynecology at RRS Hospital.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Emillia Lawrence is a dedicated healthcare professional with a passion for holistic patient care. With over 15 years of experience, Dr. Lawrence has honed her skills in diagnosing and treating a wide range of medical conditions while also providing empathetic and effective counseling to her patients.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Doo has a special interest in mental health and has helped numerous individuals navigate through life's challenges. With a career spanning over two decades, he continues to make a positive impact on the lives of those he serves.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. James Reynor is a versatile healthcare provider who believes in addressing both the physical and emotional well-being of his patients. He holds degrees in medicine and psychology, allowing him to offer a unique blend of medical expertise and counseling support.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Carter has a keen interest in mental health and has assisted numerous individuals in overcoming personal challenges. Her extensive knowledge and empathetic demeanor have made her a trusted figure in her community.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">She is a doctor who has been in practice for over 12 years.ver her achievements she use a system of alternative medicine based on the theory that diseases can be successfully treated or prevented without the use of drugs, by techniques such as control of diet, exercise, and massage.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Over the course of his career, Dr. Tan treat both acute and chronic conditions from arthritis to ear infections (otitis media), from HIV to asthma, from congestive heart failure to hepatitis. N.D.s treat the whole.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Benaro is a registered dietitian (RD) who founded "NutriVitality." With a Master's degree in Nutrition, she offers a holistic approach to nutrition and wellness.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Sarah's practice focuses on whole-food nutrition, mindful eating, and helping clients achieve their health goals through balanced, sustainable dietary choices.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Ward's practice aims to unlock the potential of genetic insights to enhance clients' health and well-being. In the realm of modern healthcare, Dr. Ward pioneers innovative practices by harnessing the power of genetic insights. Her visionary approach empowers clients to understand and optimize their genetic makeup, fostering a proactive and personalized path to well-being.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Dr. Amber, a licensed neuropsychologist, heads the Brain Wellness Center, specializing in assessing and treating neurological conditions and cognitive disorders through comprehensive assessments and cognitive rehabilitation programs, fostering enhanced cognitive functioning and quality of life for her clients.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 mb-md-3 text-center">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="truncate-lines text-justify">Over the course of his career, Dr. Baya has helped thousands of patients achieve their desired results. He treat both acute and chronic conditions from arthritis to ear infections (otitis media), from HIV to asthma, from congestive heart failure to hepatitis.</p>
                                        <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 btn_see_more" data-bs-toggle="modal" data-bs-target="#doctor">See More</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row gx-3 justify-content-center">
                    <div class="col-lg-6 order-lg-0 mb-5 mb-lg-0">
                        <div class="col-xl-auto">
                            <div class="h5 fs-2 text-white">Find Your Ideal Doctor</div>
                            <p class="lead fw-normal text-white text-justify"> Browse through our curated list of qualified healthcare professionals. Filter by specialization and availability to find the perfect match for your healthcare needs. Each doctor's profile includes a brief introduction, areas of expertise, and available appointment slots. </p>
                        </div>
                        <div class="col-xl-auto">
                            <div class="h5 fs-2 text-white">Book Your Appointment</div>
                            <p class="lead fw-normal text-white text-justify"> Provide essential details such as your name and contact information. Your information is encrypted and confidential,
                                ensuring your privacy and security. Select a convenient date and time from the available slots on the doctor's calendar. </p>
                        </div>
                        <div class="col-xl-auto">
                            <div class="h5 fs-2 text-white">Make A Payment</div>
                            <p class="lead fw-normal text-white text-justify">Confirm your appointment details and proceed to secure online payment, if applicable. You will receive a confirmation email with all the details of your scheduled appointment.</p>
                        </div>
                    </div>

                    <div class="col-lg-6 order-lg-1 mt-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body border-0 p-4">
                    <form id="join_us_form">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="join_us_prc" type="number" placeholder="..." required />
                            <label for="join_us_prc">PRC License Number</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="join_us_specialization" type="text" placeholder="..." required />
                ...
                <div class="modal-body border-0 p-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p id="doctor_description" class="text-justify"></p>
                        </div>
                    </div>
                </div>
